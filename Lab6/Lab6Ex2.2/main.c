...
int main(void)
{
    ...
    uint32_t* ref30 = (uint32_t*)0x002010EC; // ADC 2.5V reference Temp sensor 30 degree C
    uint32_t* ref85 = (uint32_t*)0x002010F0; // ADC 2.5V reference Temp sensor 85 degree C
